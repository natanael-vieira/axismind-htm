...
export default function PrivacyPage() {
  ...
  const versionLabel = { 'pt-BR': 'Versão', en: 'Version', es: 'Versión', it: 'Versione', fr: 'Version' }[locale];
  return (
    <>
      <PageIntro eyebrow={`${versionLabel} ${site.legalVersion}`} title={m.privacy.title}>
        <p>{m.privacy.intro}</p>
      </PageIntro>
      <LegalArticle>
